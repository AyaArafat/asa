 ...
 * @author shaima
 */
public class PatientsInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setForeground(new java.awt.Color(148, 26, 26));
        jButton1.setText("Veiw All");
        jButton1.setBorder(null);

        jButton2.setFont(new java.awt.Font("Constantia", 1, 12)); // NOI18N
        jButton2.setForeground(new java.awt.Color(148, 26, 26));
        jButton2.setText("Search by the ID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientsInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientsInfo().setVisible(true);
            }
        });
    }
